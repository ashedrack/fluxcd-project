...
```
kind create cluster --name fluxcd --image kindest/node:v1.28.0
```
...
```
kubectl -n default create secret docker-registry dockerhub-credential --docker-username '' --docker-password '#' --docker-email 'testozie@gmail.com'
...
flux create secret git example-app-2-github --url https://github.com/ashedrack/fluxcd-project --username 'ashedrack' --password 'daberechi_123#' --namespace default
```
...
docker push aim/example-app-2:0.0.2
